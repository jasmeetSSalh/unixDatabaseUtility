...
INSERT INTO PHARM_MED_INVENTORY (MEDICINE_ID, DRUG_NAME, DOSAGE, DRUG_DESCRIPTION, COMPANY, QUANTITY, DRUG_TYPE, ACCESS_LEVEL, EXPIRY_DATE, DRUG_COST)
VALUES (1001, 'Aspirin', '100mg', 'Pain reliever and anti-inflammatory', 'PharmaCorp', 5000, 'Tablet', 1, TO_DATE('2026-12-31', 'YYYY-MM-DD'), 0.50);
INSERT INTO PHARM_MED_INVENTORY (MEDICINE_ID, DRUG_NAME, DOSAGE, DRUG_DESCRIPTION, COMPANY, QUANTITY, DRUG_TYPE, ACCESS_LEVEL, EXPIRY_DATE, DRUG_COST)
VALUES (1002, 'Morphine Sulfate', '10mg/mL', 'Opioid analgesic for severe pain', 'MedSupply Inc', 200, 'Injectable', 5, TO_DATE('2025-11-30', 'YYYY-MM-DD'), 25.00);
INSERT INTO PHARM_MED_INVENTORY (MEDICINE_ID, DRUG_NAME, DOSAGE, DRUG_DESCRIPTION, COMPANY, QUANTITY, DRUG_TYPE, ACCESS_LEVEL, EXPIRY_DATE, DRUG_COST)
VALUES (1003, 'Amoxicillin', '500mg', 'Antibiotic for bacterial infections', 'GlobalMed', 3000, 'Capsule', 2, TO_DATE('2026-06-30', 'YYYY-MM-DD'), 1.25);
